...
# on your computer
my_path <- "C:/Users/kcorreia/Dropbox (Amherst College)"
...
covid_worldwide_7 <- readRDS(file = glue::glue("{my_path}/Stat231-SunnyDay-data/covid_worldwide_7.RDS"))
```
...
covid_worldwide_7 <- readRDS("data/covid_worldwide_7.RDS")
...
my_palette <- colorQuantile(rev(viridis::viridis(5))
                  , domain =  covid_worldwide_8_leaflet$total_cases_capita, n=5)
